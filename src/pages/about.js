...
export default function renderAbout() {
    ...
    return (
        <Container id="about" className="d-flex justify-content-center mt-5 pt-3 mb-2">
            <Card className="mt-4 m-3 p-1 background-light" style={styles.card}>
                <Card.Body className="m-1">
                    <Card.Title className="display-4 text-center gradient-text fw-bold heading-font mt-2">About Me</Card.Title>
                </Card.Body>
                <Row className="d-flex justify-content-center ms-2 mb-2">
                    <Col md={11} className="me-2 mb-3">
                        <Row className="flex-nowrap">
                            <Col className="card-text me-2 dark-accent pb-3">
                                <p className="justify fs-medium">
                                    Raised on the coast of Brazil, I relocated to the US in 2020 and since then, technology has been my calling.
                                    I believe that <span className="gradient-text fw-semibold">coding</span> was destined to choose me, as I take pleasure in
                        ...
                        <Row className="flex-nowrap">
                            <Col className="card-text me-2 dark-accent pb-2">
                                <p className="justify fs-medium">
