            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="navbarSupportedContent">
                    ...
                    <Nav className="ms-auto mb-2 mb-lg-0 justify-content-end">
                        ...
                        <Nav.Link className={`nav-link dark-accent gradient-hv mt-2 fs-5 fw-semibold ${currentPage === "Resume" ? "gradient-text" : ""}`} href="#Resume" onClick={() => setCurrentPage("Resume")}>Resume</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
